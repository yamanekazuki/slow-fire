...
# アンBBQ（An BBQ / ニューバーベキュー）の思想 — 正本 AN-BBQ-PHILOSOPHY.md の凝縮
- アメリカンBBQの優れたロジック（蓋付きグリル・間接熱・ロー&スロー・温度の科学）は継承する。
  ただし12時間級の長時間燻製スタイルは日本の暮らしに根づかない。その限界を超えて日常に溶け込む新概念が「アンBBQ」。
- コピーの3原則:
...
const TOPIC_SEEDS = [
  ...
  // --- アンBBQ（日本の暮らしに翻訳したニューバーベキュー） ---
  "アンBBQとは何か——12時間の憧れと、5〜6時間の現実",
  "普通のスーパーの食材が劇的に美味しくなる、蓋付きグリルのロジック",
  "冷めたプルドポーク問題——熱々を出来立てで配るBBQの設計",
  "肉2〜3種＋副菜＋シーフード：飽きさせないアンBBQの組み立て方",
...
- A系統=アメリカンBBQ探求の入口記事: ロー&スロー・ラブ・温度管理・ブリスケットなど、本場アメリカンBBQに憧れて検索してきた読者向け。憧れと探求心にまっすぐ応える。
  ただし結びで一段だけ、自然にアンBBQへの橋を架ける——読者が遠からず突き当たる同じ課題（12時間は現実的でない・塊肉は冷める・単調）にそっと触れ、「5〜6時間で完結する日本の暮らしに翻訳したやり方（アンBBQ）もある」と示す。橋は1段だけ。説教や宗旨替えの強要にせず、アメリカンBBQ探求そのものは否定しない。
- B系統=アンBBQ実践記事: アンBBQの思想（5〜6時間完結・熱々を出来立てで・多品種・普通のスーパーの食材・蓋付きグリルのロジック）を正面から実践的に書く。
- どちらの系統でも、アメリカンBBQの温度の科学・道具のロジックという土台は共通。全部をアンBBQに寄せず、入口記事の役割も大切にする。
...
<body>
  ...
  <header class="blog-hero">
    <div class="blog-hero-inner">
      ...
      <p class="blog-hero-sub">本場アメリカンBBQの探求も、日本の暮らしに翻訳したアンBBQも。温度・時間・道具という技術の話から、なぜBBQが「場」を変えるのかという話まで。Weber Grill Academy受講チームが、実体験から綴ります。</p>
    </div>
  </header>
